...
def upgrade() -> None:
    ...
    op.create_unique_constraint('_inbound_user_uc', 'clients', ['user_id', 'inbound_id'])
    ...
    op.create_foreign_key(None, 'clients', 'inbounds', ['inbound_id'], ['id'], ondelete='CASCADE')
    op.drop_column('clients', 'user')
    op.drop_column('clients', 'inbound')
    op.drop_constraint('_host_location_uc', 'inbounds', type_='unique')
    op.create_unique_constraint('_host_inbound_id_uc', 'inbounds', ['host', 'inbound_id'])
...
def downgrade() -> None:
    ...
    op.add_column('clients', sa.Column('inbound', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('clients', sa.Column('user', sa.INTEGER(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'clients', type_='foreignkey')
    op.drop_constraint(None, 'clients', type_='foreignkey')
    op.create_foreign_key('clients_inbound_fkey', 'clients', 'inbounds', ['inbound'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('clients_user_fkey', 'clients', 'users', ['user'], ['id'], ondelete='CASCADE')
